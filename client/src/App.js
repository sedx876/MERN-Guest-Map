...
import { getMessages, getLocation, sendMessage } from './components/API';
    ...
    return (
      <div className="map">
        ...
        <Card className="footer">
          <CardText> Made with <span role="img" aria-label="love">💚</span> by <a href="https://github.com/sedx876" target="_blank" rel="noopener noreferrer">Sedx876</a></CardText>
        </Card>
      </div>
    );
  }
